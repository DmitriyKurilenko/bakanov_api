...
BITRIX24_INBOUND_TOKEN = os.getenv("BITRIX24_INBOUND_TOKEN", "")
BITRIX24_TIMEOUT = int(os.getenv("BITRIX24_TIMEOUT", "30"))
BITRIX24_APP_ID = os.getenv("BITRIX24_APP_ID", "")
BITRIX24_APP_SECRET = os.getenv("BITRIX24_APP_SECRET", "")
...
BITRIX24_CONTRACT_FIELD_BOAT_TYPE = os.getenv("BITRIX24_CONTRACT_FIELD_BOAT_TYPE", "")
BITRIX24_CONTRACT_FIELD_CABINS = os.getenv("BITRIX24_CONTRACT_FIELD_CABINS", "")
BITRIX24_CONTRACT_FIELD_CLIENTS = os.getenv("BITRIX24_CONTRACT_FIELD_CLIENTS", "")
BITRIX24_CONTRACT_FIELD_CLIENT_COUNTRY = os.getenv("BITRIX24_CONTRACT_FIELD_CLIENT_COUNTRY", "")
BITRIX24_CONTRACT_FIELD_TRIP_START = os.getenv("BITRIX24_CONTRACT_FIELD_TRIP_START", "")
BITRIX24_CONTRACT_FIELD_TRIP_END = os.getenv("BITRIX24_CONTRACT_FIELD_TRIP_END", "")
BITRIX24_CONTRACT_FIELD_CRUISE_TYPE = os.getenv("BITRIX24_CONTRACT_FIELD_CRUISE_TYPE", "")
BITRIX24_CONTRACT_FIELD_EXTRA = os.getenv("BITRIX24_CONTRACT_FIELD_EXTRA", "")
BITRIX24_CONTRACT_FIELD_TAX = os.getenv("BITRIX24_CONTRACT_FIELD_TAX", "")
BITRIX24_CONTRACT_FILE_FIELD_ID = os.getenv("BITRIX24_CONTRACT_FILE_FIELD_ID", "")
# Bitrix24 Contact field mapping
BITRIX24_CONTRACT_FIELD_BIRTHDATE = os.getenv("BITRIX24_CONTRACT_FIELD_BIRTHDATE", "")
BITRIX24_CONTRACT_FIELD_PASSPORT_NUMBER = os.getenv("BITRIX24_CONTRACT_FIELD_PASSPORT_NUMBER", "")
BITRIX24_CONTRACT_FIELD_PASSPORT_DATE = os.getenv("BITRIX24_CONTRACT_FIELD_PASSPORT_DATE", "")
BITRIX24_CONTRACT_FIELD_PASSPORT_ISSUED = os.getenv("BITRIX24_CONTRACT_FIELD_PASSPORT_ISSUED", "")
BITRIX24_CONTRACT_FIELD_PASSPORT_BPLACE = os.getenv("BITRIX24_CONTRACT_FIELD_PASSPORT_BPLACE", "")
